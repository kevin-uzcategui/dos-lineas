...
class Title extends Widget_Base{
  ...
  public function get_title(){
    ...
    return esc_html__( 'Decorative Title', 'dos-lineas' );
        ...
        $this->add_control(
           ...
           [
            ...
            'selectors' => [
              ...
              '{{WRAPPER}} .titlewidget::before' => 'border-color: {{VALUE}};',

              '{{WRAPPER}} .titlewidget::after' => 'border-color: {{VALUE}};',
